    ...
    <div className=" min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40">
        {/* <img src={assets.logo} alt="" className=' h-12 object-contain'/> */}
          <div class="text-6xl font-bold bg-gradient-to-r from-red-500 via-yellow-500 via-green-500 via-blue-500 via-indigo-500 to-purple-500 bg-clip-text text-transparent animate-pulse">
              CONNEXT
            </div>
        <div>
          ...
          <p className="text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md">
            connect with global comunity on{" "}
